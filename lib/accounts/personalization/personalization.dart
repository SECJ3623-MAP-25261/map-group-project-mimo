          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  _buildStat('8', 'Items Listed'),
                  _buildStat(
                    'RM${renter.earnings.toStringAsFixed(2)}',
                    'Earnings',
                  ),
                  _buildStat('${renter.pendingRequests}', 'Requests'),
                ],
              ),
              ...
              _menuButton(context, 'Return to Profile', Icons.person),
